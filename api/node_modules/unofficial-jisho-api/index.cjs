...
var axiosBuilder = require('axios');
var cheerio = require('cheerio');
var escapeStringRegexp = require('escape-string-regexp');
var htmlEntities$1 = require('html-entities');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var axiosBuilder__default = /*#__PURE__*/_interopDefaultLegacy(axiosBuilder);
...
const axios = axiosBuilder__default['default'].create({ timeout: 10000 });
...
const htmlEntities = new htmlEntities$1.XmlEntities();
...
function getStringBetweenStrings(data, startString, endString) {
  const regex = new RegExp(`${escapeStringRegexp__default['default'](startString)}(.*?)${escapeStringRegexp__default['default'](endString)}`, 's');
...
function parseExamplePageData(pageHtml, phrase) {
  ...
  const $ = cheerio__default['default'].load(pageHtmlReplaced);
...
function parsePhrasePageData(pageHtml, query) {
  const $ = cheerio__default['default'].load(pageHtml);
